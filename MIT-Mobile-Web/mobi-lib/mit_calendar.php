...
//define('EVENTS_CALENDAR_API', 'http://events.unc.edu/cal/main/showEventList.rdo');
MIT_Calendar::init();
...
class MIT_Calendar {
  ...
  public static function TodaysExhibitsHeaders($date) {
    //return self::HeadersByCatID(5, $date, $date);
      $slook = new stdClass;
      $slook->title = "Harry Potter and the Go Fuck yourself";
      $slook->id = "http://maddox.xmission.net";
   echo $date;
